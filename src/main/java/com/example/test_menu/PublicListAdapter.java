    ...
    public void onBindViewHolder(PublicViewHolder holder, int position) {
        ...
        holder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context,ViewPalette.class);
                ...
                bundle.putString("date", holder.tv_date.getText().toString());
                bundle.putString("heart_count",holder.tv_heartCount.getText().toString());
